...
import { LogIn, UserPlus, Mail, Lock, User, CheckCircle2, ShieldCheck, X } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl p-5 md:p-6 max-w-md w-full border border-forest-800/20 shadow-2xl space-y-4 relative overflow-y-auto max-h-[calc(100vh-2rem)] my-auto">
        ...
        <div className="flex items-center justify-between border-b border-forest-800/10 pb-3">
          ...
          <button
            ...
            className="p-1 text-forest-800/40 hover:text-forest-900 font-bold text-lg rounded-xl hover:bg-forest-800/5 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* 1. Official Google Sign-In Primary Button */}
        {!showGooglePrompt ? (
          <div className="space-y-3">
            <button
              onClick={handleQuickGoogle}
              className="w-full py-3.5 px-4 rounded-2xl bg-white border border-gray-300 text-gray-800 font-bold text-xs flex items-center justify-center gap-3 shadow-md hover:shadow-lg hover:bg-gray-50 transition-all hover:scale-[1.01] group"
            >
          ...
          /* Google Quick Form */
          <form onSubmit={handleGoogleSubmit} className="bg-blue-50/70 p-4 rounded-2xl border border-blue-200 space-y-3">
            ...
            <input
              ...
              className="w-full bg-white border border-blue-300 rounded-xl p-3 text-xs outline-none focus:border-blue-500 font-medium"
            />
            <button
              type="submit"
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow transition-colors"
            >
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-3 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-forest-50 border border-forest-800/15 rounded-xl pl-9 p-3 outline-none focus:border-harvest-500 font-medium"
                />
              </div>
            </div>
          )}
          ...
          <button
            type="submit"
            className="w-full py-3.5 rounded-2xl badge-forest font-bold shadow-md hover:scale-[1.01] transition-transform text-xs flex items-center justify-center gap-2 mt-2"
          >
            {activeTab === 'login' ? (
              <>
        ...
        {/* Security Note */}
        <div className="flex items-center justify-center gap-1 text-[11px] text-forest-800/60 pt-1">
